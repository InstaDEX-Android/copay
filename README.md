<img src="https://raw.githubusercontent.com/instadex/copay/master/resources/copay/android/icon/drawable-xxxhdpi-icon.png" alt="Copay" width="79">

[![Build Status](https://secure.travis-ci.org/instadex/copay.svg)](http://travis-ci.org/instadex/copay)

InstaDEX Copay is a secure instadex wallet platform for both desktop and mobile devices. Copay uses [Bitcore Wallet Service](https://github.com/instadex-android/bitcore-wallet-service) (BWS) for peer synchronization and network interfacing.
...
- Support for InstaDEX testnet wallets
...
Information about backup and recovery procedures is available at: https://github.com/instadex-android/copay/blob/master/backupRecovery.md
...
Copay depends on [Bitcore Wallet Service](https://github.com/instadex-android/bitcore-wallet-service) (BWS) for blockchain information, networking and Copayer synchronization.  A BWS instance can be setup and operational within minutes or you can use a public instance like `https://bws.instadex.io`.  Switching between BWS instances is very simple and can be done with a click from within Copay.  BWS also allows Copay to interoperate with other wallets like [Bitcore Wallet CLI] (https://github.com/instadex-android/bitcore-wallet).
...
Finally, in case you lose the device and you have the 24 word seed for the device, you can recover access to your funds using Copay, see: https://github.com/instadex-android/copay/blob/master/backupRecovery.md#hardware-wallets
...
Copay is released under the MIT License.  Please refer to the [LICENSE](https://github.com/instadex-android/copay/blob/master/LICENSE) file that accompanies this project for more information including complete terms and conditions.
